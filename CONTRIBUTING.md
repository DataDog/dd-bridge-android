...
This project hosts the following modules:
  ...
  - `dd-bridge-android`: the main bridge providing access to the bridge's features.

### Building the Bridge

You can build the Bridge using the following Gradle command:
...
To share your request, you can open an [issue](https://github.com/DataDog/dd-bridge-android/issues/new) 
...
You may submit bug reports concerning the Datadog Bridge for Android by 
[opening a Github issue](https://github.com/DataDog/dd-bridge-android/issues/new).
...
[submit as a pull request](https://github.com/DataDog/dd-bridge-android/pull/new/master).
...
1. **Fork the repository** from https://github.com/DataDog/dd-bridge-android ;
...
5. **Submit the pull request** from your fork back to this 
    [repository](https://github.com/DataDog/dd-bridge-android) .
...
./gradlew :dd-bridge-android:ktlintFormat
